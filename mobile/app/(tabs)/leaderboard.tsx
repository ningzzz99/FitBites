...
export default function LeaderboardScreen() {
  ...
  const [friendRowsLeaderboard, setFriendRowsLeaderboard] = useState<LeaderboardEntry[]>([]);
  ...
  function hasFriendRelation(userId: number) {
  ...
  async function requestFriend(targetUserId: number) {
    try {
  ...
  return (
    ...
    >
      ...
      <View style={styles.segmentWrap}>
        <Pressable style={[styles.segmentBtn, tab === 'global' && styles.segmentBtnActive]} onPress={() => setTab('global')}>
          <Text style={[styles.segmentText, tab === 'global' && styles.segmentTextActive]}>Worldwide</Text>
        </Pressable>
        <Pressable style={[styles.segmentBtn, tab === 'friends' && styles.segmentBtnActive]} onPress={() => setTab('friends')}>
          ...
          {visibleRows.map((row, idx) => (
            <View key={row.user_id} style={styles.rankRow}>
              ...
              <View style={styles.rankMain}>
                <Text style={[styles.rankName, row.user_id === currentUserId && styles.currentUserName]}>{row.username}</Text>
                <Text style={styles.rankMeta}>Streak {row.streak_count} | Coins {row.total_coins}</Text>
              </View>
            </View>
          ))}
        </View>
